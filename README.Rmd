...
The language link menu can be placed in the *sidebar* or in the *navbar*. To change the placement, use the languagelinks field in the babelquarto YAML key, in `_quarto.yml`:
...
Beware: depending on the languagelinks' value, the corresponding menu needs to be configured. Books always have a *sidebar*, but websites can have either *navbar* or *sidebar*.
