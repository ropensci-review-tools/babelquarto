...
When you render a project in a CI context, you can set the URL of the publishing website in an environment variable (if different from the one in the `_quarto.yml` configuration file,
as a preview for instance).
...
* The [training materials for rOpenSci mentors](https://ropensci-training.github.io/ropensci-mentors/), a website with its [workflow file](https://github.com/ropensci-training/ropensci-mentors/blob/main/.github/workflows/publish.yml).
