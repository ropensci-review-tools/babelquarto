...
If you want to style the button with CSS, note it has the id `"language-buttons"` and the class `"babelquarto-languages-button"`.
...
In {babelquarto} we will automatically load a language profile if it exists in the project directory and follows our naming convention: `_quarto-<languagecode>.yml`.
