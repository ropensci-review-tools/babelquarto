...
The goal of this vignette is to show how you can start a new multilingual Quarto project using {babelquarto}.
There are two types of project you can start: a book or a website. We will look at each type seperately below.
...
quarto_multilingual_book(parent_dir = parent_dir, project_dir = project_dir)
```
...
When you're ready to render your website, use `render_website()`:
